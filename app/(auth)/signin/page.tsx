      ...
      <div className="w-full max-w-md">
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-8">
          ...
          <button
            ...
            disabled={isLoading || isGoogleLoading}
            className="w-full px-4 py-2 bg-gray-100 hover:bg-gray-200 border border-gray-300 text-gray-900 font-semibold rounded-lg transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
          ...
          <p className="text-gray-600 text-center mt-6">
            ...
            <Link href="/verify-email" className="text-gray-900 hover:text-gray-700 font-semibold">
              Sign Up
            </Link>
          </p>
        </div>
